...
export default function ProjectsSection() {
  ...
  return (
    <section
      id="projects"
      ref={ref}
      className="relative py-24 mt-20 px-4 sm:px-6 overflow-hidden"
    >
      {/* Background */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-40 right-[10%] w-72 h-72 bg-gradient-to-r from-cyan-700/10 to-blue-700/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-40 left-[10%] w-72 h-72 bg-gradient-to-r from-purple-700/10 to-pink-700/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex justify-center mt-8 space-x-2 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filteredProjects.map((project, index) => (
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-white/5 to-white/[0.02] rounded-2xl overflow-hidden border border-white/10 hover:border-cyan-500/50 transition-all duration-300"
            >
              <SmallCorner
              ...
              <div className="p-6 relative">
                {project.featured && (
                  <div className="absolute top-6 right-6 px-3 py-1 bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-xs font-medium rounded-full">
                    Featured
                  </div>
                )}
